...
""" The game itself, the entry point of the program.
 Contains the game's logic, a turn based CLI battleship game"""
...
def main():
    """ The Battleship game's entry point"""

    print """
    #Bienvenue à Navire De Guerre, là où tout est meilleur en CLI!
    #
    #     Vous devez couler les navires adverses avant que les vôtres
    #     le soient.
    #
    ...
    # l'autre. Tous les joueurs doivent avoir le game_manager pour pouvoir
    # placer les bateaux et tirer. Les joueurs sont reconnus avec leur ID. Tu
    # utilises le mauvais ID: tu t'attaques toi-meme. T'as juste a pas y
    # toucher.

    # for testing purposes, you can set the two players as AIs
    # first_player = Player(game_manager, 0)
